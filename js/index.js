$(document).ready(function () {
  ...
  $(".login").click(function (e) {
    $(".begin_login").show();
    $(".begin_login_card").addClass("isClicked");
  });
        ...
        columns: [
          {
            ...
            cellTemplate(container, options) {
              $("<div>")
                .append($("<i>", { class: "fa-solid fa-paperclip" }))
                .appendTo(container);
            },
          },
          {
          ...
          },
          {
            ...
            cellTemplate(container, options) {
              $("<div>")
                .append($("<i>", { class: "fa-solid fa-message" }))
                .appendTo(container);
            },
          },
          {
          ...
          },
          {
            ...
            cellTemplate(container, options) {
              $("<div>")
                .append($("<i>", { class: "dx-icon-textdocument" }))
                .appendTo(container);
            },
          },
          {
